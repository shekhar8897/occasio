  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color:orangered">FORM</h5>
...
<center><button type="submit" class="btn btn-raised btn-primary">SUBMIT</button></center>
